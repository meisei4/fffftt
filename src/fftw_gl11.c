...
int main(void) {
    ...
    fftw_complex* fftw_input = fftw_malloc(sizeof(fftw_complex) * WINDOW_SIZE);
    fftw_complex* fftw_output = fftw_malloc(sizeof(fftw_complex) * WINDOW_SIZE);
    fftw_plan fftw_plan_state = fftw_create_plan(WINDOW_SIZE, FFTW_FORWARD, FFTW_ESTIMATE);
    SetTargetFPS(60);
