...
SH4ZAM_BUILD_DIR := $(BUILD_DIR)/dc/sh4zam
...
$(SH4ZAM_BUTTERFLY_ELF): TARGET_LDLIBS := $(DC_WAV_LDLIBS) $(SH4ZAM_LIB)
$(SH4ZAM_BUTTERFLY_ELF): EXTRA_OBJS := $(SH4ZAM_LIB)
$(SH4ZAM_BUTTERFLY_ELF): $(SH4ZAM_BUTTERFLY_SRC) $(SH4ZAM_LIB)
...
$(PICKING_OUT_NOTES_DC_ELF): $(PICKING_OUT_NOTES_DC_SRC) $(SH4ZAM_LIB)
...
$(FFT_TERRAIN_3D_DC_ELF): $(FFT_TERRAIN_3D_DC_SRC) $(SH4ZAM_LIB)
...
$(FFT_BANDS_TERRAIN_3D_DC_ELF): $(FFT_BANDS_TERRAIN_3D_DC_SRC) $(SH4ZAM_LIB)
...
$(SH4ZAM_LIB):
	...
	cd $(SH4ZAM_DIR) && cmake --fresh -G "$(CMAKE_GENERATOR)" -S . -B $(abspath $(SH4ZAM_BUILD_DIR)) -DCMAKE_TOOLCHAIN_FILE=$(GLDC_TOOLCHAIN) -DCMAKE_BUILD_TYPE=Release
	$(CMAKE) --build $(SH4ZAM_BUILD_DIR) --parallel
	@test -f $(SH4ZAM_LIB)
